...
import stylesCss from 'themes/autograder-theme/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_autograder-theme_componentCss']) {
    
    document['_vaadintheme_autograder-theme_componentCss'] = true;
  }
